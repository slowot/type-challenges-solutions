...
export type MinusOne<N extends number> = PlusOrMinusOne<N, "-">;
export type PlusOne<N extends number> = PlusOrMinusOne<N, "+">;
...
export type Plus<Left extends number, Right extends number> = PlusOrMinus<
  Left,
  Right,
  "+"
>;
export type Minus<Left extends number, Right extends number> = PlusOrMinus<
  Left,
  Right,
  "-"
>;
